...
def main():
    ...
    parser.add_argument(
        '--index',
        type=Path,
        default=Path("outputs/vector_indices/dinov3_indices/high_density/indexhnswflat_clustered.index"),
        help='Índice FAISS (generado del TRAIN set)'
    )
    parser.add_argument(
        '--metadata',
        type=Path,
        default=Path("outputs/vector_indices/dinov3_indices/high_density/metadata_clustered.pkl"),
    ...
    parser.add_argument(
        '--output',
        type=Path,
        default=Path("outputs/rag_evaluation"),

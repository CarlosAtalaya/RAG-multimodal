# src/core/embeddings/multimodal_embedder_v2.py

"""
🧠 MULTIMODAL EMBEDDER V2 - Visual + Textual (con soporte para imágenes sin daño)

Diferencias vs V1:
- Soporta metadata con 'has_damage' flag
- Descripción textual optimizada para caso sin daño
- Mismo formato de salida (1408 dims)
"""
...
class MultimodalEmbedderV2:
    ...
    def __init__(
        ...
        print(f"🔧 Inicializando MultimodalEmbedderV2...")
        ...
        print(f"\n✅ MultimodalEmbedderV2 inicializado")
    ...
    def build_text_description(self, metadata: Dict) -> str:
        ...
        # Caso 1: SIN DAÑO
        if not has_damage or not metadata.get('defect_types', []):
        ...
        for dtype, count in type_counts.most_common():
            ...
            damage_parts.append(f"{count} {dtype.replace('_', ' ')}{plural}")
